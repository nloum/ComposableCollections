...
public virtual TBase Value => Convert1(Item1) ?? Convert2(Item2) ?? Convert3(Item3) ?? Convert4(Item4) ?? Convert5(Item5) ?? Convert6(Item6) ?? Convert7(Item7) ?? Convert8(Item8) ?? Convert9(Item9) ?? Convert10(Item10) ?? Convert11(Item11) ?? Convert12(Item12) ?? Convert13(Item13) ?? Convert14(Item14);
}
}
