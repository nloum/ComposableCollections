...
{
    public class CachedWriteQueryableDictionaryAdapter<TKey, TValue> : DelegateDictionaryBase<TKey, TValue>, ICachedWriteQueryableDictionary<TKey, TValue>
    {
        ...
        protected CachedWriteQueryableDictionaryAdapter()
        {
        }
