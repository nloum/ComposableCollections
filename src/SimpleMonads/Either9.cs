...
public static implicit operator T1(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item1.Value;
}
public static implicit operator T2(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item2.Value;
}
public static implicit operator T3(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item3.Value;
}
public static implicit operator T4(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item4.Value;
}
public static implicit operator T5(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item5.Value;
}
public static implicit operator T6(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item6.Value;
}
public static implicit operator T7(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item7.Value;
}
public static implicit operator T8(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item8.Value;
}
public static implicit operator T9(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item9.Value;
}
public static implicit operator Maybe<T1>(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T1>)either.Item1;
}
public static implicit operator Maybe<T2>(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T2>)either.Item2;
}
public static implicit operator Maybe<T3>(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T3>)either.Item3;
}
public static implicit operator Maybe<T4>(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T4>)either.Item4;
}
public static implicit operator Maybe<T5>(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T5>)either.Item5;
}
public static implicit operator Maybe<T6>(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T6>)either.Item6;
}
public static implicit operator Maybe<T7>(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T7>)either.Item7;
}
public static implicit operator Maybe<T8>(EitherBase<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
...
public virtual TBase Value => Item1.Cast<TBase>().Otherwise(Item2.Cast<TBase>().Otherwise(Item3.Cast<TBase>().Otherwise(Item4.Cast<TBase>().Otherwise(Item5.Cast<TBase>().Otherwise(Item6.Cast<TBase>().Otherwise(Item7.Cast<TBase>().Otherwise(Item8.Cast<TBase>().Otherwise(() => (TBase)Item9.Cast<TBase>().Value))))))));
}
}
