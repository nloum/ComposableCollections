...
public class AnonymousWriteCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> : IWriteCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> {
...
public AnonymousWriteCachedQueryableDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IQueryableDictionary<TKey, TValue>> asQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IQueryableReadOnlyDictionary<TKey, TValue>> asQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDictionary<TKey, TValue>> asWriteCachedDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedQueryableDictionary<TKey, TValue>> asWriteCachedQueryableDictionary, Action flushCache, Func<IQueryable<TValue>> getValues) {
