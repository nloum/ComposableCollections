...
public class AnonymousReadCachedReadOnlyDictionaryWithBuiltInKey<TKey, TValue> : IReadCachedReadOnlyDictionaryWithBuiltInKey<TKey, TValue> {
...
public AnonymousReadCachedReadOnlyDictionaryWithBuiltInKey(IReadOnlyDictionaryWithBuiltInKey<TKey, TValue> readOnlyDictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedReadOnlyDictionary<TKey, TValue>> asReadCachedReadOnlyDictionary, Action reloadCache) {
