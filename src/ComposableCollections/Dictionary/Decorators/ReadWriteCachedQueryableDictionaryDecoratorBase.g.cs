...
public class ReadWriteCachedQueryableDictionaryDecoratorBase<TKey, TValue> : IReadWriteCachedQueryableDictionary<TKey, TValue> {
private readonly IReadWriteCachedQueryableDictionary<TKey, TValue> _decoratedObject;
