...
{
    public class WriteCachedDictionaryAdapter<TKey, TValue> : DelegateDictionaryBase<TKey, TValue>, IWriteCachedDictionary<TKey, TValue>
    {
        ...
        public WriteCachedDictionaryAdapter(IComposableDictionary<TKey, TValue> source, Func<IComposableReadOnlyDictionary<TKey, TValue>> asBypassCache, Func<IComposableDictionary<TKey, TValue>> asNeverFlush, Action flushCache, Func<bool, IEnumerable<DictionaryWrite<TKey, TValue>>> getWrites) : base(source)
        {
        ...
        protected WriteCachedDictionaryAdapter()
        {
        }
