...
public class AnonymousReadWriteCachedDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> : IReadWriteCachedDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> {
...
private readonly Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableQueryableDictionary<TKey, TValue>> _asReadCachedDisposableQueryableDictionary;
...
private readonly Func<ComposableCollections.Dictionary.Interfaces.IReadCachedQueryableDictionary<TKey, TValue>> _asReadCachedQueryableDictionary;
...
private readonly Func<ComposableCollections.Dictionary.Interfaces.IReadWriteCachedDisposableQueryableDictionary<TKey, TValue>> _asReadWriteCachedDisposableQueryableDictionary;
...
public AnonymousReadWriteCachedDisposableQueryableDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IDisposableDictionary<TKey, TValue>> asDisposableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IDisposableQueryableDictionary<TKey, TValue>> asDisposableQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IDisposableQueryableReadOnlyDictionary<TKey, TValue>> asDisposableQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IDisposableReadOnlyDictionary<TKey, TValue>> asDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IQueryableDictionary<TKey, TValue>> asQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IQueryableReadOnlyDictionary<TKey, TValue>> asQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableQueryableDictionary<TKey, TValue>> asReadCachedDisposableQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableQueryableReadOnlyDictionary<TKey, TValue>> asReadCachedDisposableQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableReadOnlyDictionary<TKey, TValue>> asReadCachedDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedQueryableDictionary<TKey, TValue>> asReadCachedQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedQueryableReadOnlyDictionary<TKey, TValue>> asReadCachedQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedReadOnlyDictionary<TKey, TValue>> asReadCachedReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadWriteCachedDisposableQueryableDictionary<TKey, TValue>> asReadWriteCachedDisposableQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDictionary<TKey, TValue>> asWriteCachedDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDisposableDictionary<TKey, TValue>> asWriteCachedDisposableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDisposableQueryableDictionary<TKey, TValue>> asWriteCachedDisposableQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedQueryableDictionary<TKey, TValue>> asWriteCachedQueryableDictionary, Action dispose, Action flushCache, Func<IQueryable<TValue>> getValues, Action reloadCache) {
_asReadWriteCachedDisposableQueryableDictionary = asReadWriteCachedDisposableQueryableDictionary;
_asReadCachedDisposableQueryableDictionary = asReadCachedDisposableQueryableDictionary;
...
_asReadCachedQueryableDictionary = asReadCachedQueryableDictionary;
...
public virtual ComposableCollections.Dictionary.Interfaces.IReadWriteCachedDisposableQueryableDictionary<TKey, TValue> AsReadWriteCachedDisposableQueryableDictionary() {
return _asReadWriteCachedDisposableQueryableDictionary();
}
public virtual ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableQueryableDictionary<TKey, TValue> AsReadCachedDisposableQueryableDictionary() {
return _asReadCachedDisposableQueryableDictionary();
}
...
public virtual ComposableCollections.Dictionary.Interfaces.IReadCachedQueryableDictionary<TKey, TValue> AsReadCachedQueryableDictionary() {
return _asReadCachedQueryableDictionary();
}
