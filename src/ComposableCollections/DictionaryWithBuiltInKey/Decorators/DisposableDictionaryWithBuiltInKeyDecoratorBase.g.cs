...
public class DisposableDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IDisposableDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IDisposableDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public DisposableDictionaryWithBuiltInKeyDecoratorBase(IDisposableDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
