...
{
public static IEither<T1B, T2, T3, T4> Select1<T1A, T1B, T2, T3, T4>(IEither<T1A, T2, T3, T4> either, Func<T1A, T1B> selector)
{
...
public static IEither<T1, T2B, T3, T4> Select2<T1, T2A, T2B, T3, T4>(IEither<T1, T2A, T3, T4> either, Func<T2A, T2B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3B, T4> Select3<T1, T2, T3A, T3B, T4>(IEither<T1, T2, T3A, T4> either, Func<T3A, T3B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3, T4B> Select4<T1, T2, T3, T4A, T4B>(IEither<T1, T2, T3, T4A> either, Func<T4A, T4B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1B, T2B, T3B, T4B> Select<T1A, T2A, T3A, T4A, T1B, T2B, T3B, T4B>(this IEither<T1A, T2A, T3A, T4A> input, Func<T1A, T1B> selector1, Func<T2A, T2B> selector2, Func<T3A, T3B> selector3, Func<T4A, T4B> selector4) {
...
public static IEither<T1, T2, T3, T4> ForEach<T1, T2, T3, T4>(this IEither<T1, T2, T3, T4> input, Action<T1> action1, Action<T2> action2, Action<T3> action3, Action<T4> action4) {
if (input.Item1.HasValue) {
