...
public class ReadCachedDisposableDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IReadCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IReadCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public ReadCachedDisposableDictionaryWithBuiltInKeyDecoratorBase(IReadCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
