...
namespace ComposableCollections.DictionaryWithBuiltInKey.Interfaces
{
    ...
    /// </summary>
    public interface IWriteCachedDictionaryWithBuiltInKey<TKey, TValue> : IDictionaryWithBuiltInKey<TKey, TValue>
    {
        IWriteCachedDictionary<TKey, TValue> AsWriteCachedDictionary();
        void FlushCache();
    }
}