...
public AnonymousReadCachedQueryableDictionary(IComposableDictionary<TKey, TValue> composableDictionary, Func<IQueryable<TValue>> getValues, Action invalidCache, Action<TKey> invalidCache1, Action reloadCache, Action<TKey> reloadCache1) {
