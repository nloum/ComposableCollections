...
public class ReadCachedDisposableDictionaryDecoratorBase<TKey, TValue> : IReadCachedDisposableDictionary<TKey, TValue> {
private readonly IReadCachedDisposableDictionary<TKey, TValue> _decoratedObject;
