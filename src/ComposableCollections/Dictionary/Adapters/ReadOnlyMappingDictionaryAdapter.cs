...
namespace ComposableCollections.Dictionary.Adapters
{
    ...
    /// </summary>
    public class ReadOnlyMappingDictionaryAdapter<TKey1, TValue1, TKey2, TValue2> : ReadOnlyDictionaryBase<TKey2, TValue2>
    {
        ...
        protected ReadOnlyMappingDictionaryAdapter(IComposableReadOnlyDictionary<TKey1, TValue1> innerValues)
        {
            _innerValues = innerValues;
        }

        public ReadOnlyMappingDictionaryAdapter(IComposableReadOnlyDictionary<TKey1, TValue1> innerValues, Func<TKey1, TValue1, IKeyValue<TKey2, TValue2>> convertTo2, Func<TKey2, TKey1> convertToKey1, Func<TKey1, TKey2> convertToKey2)
        {
            _innerValues = innerValues;
