...
public class AnonymousWriteCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> : IWriteCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> {
...
public AnonymousWriteCachedDisposableDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IDisposableDictionary<TKey, TValue>> asDisposableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IDisposableReadOnlyDictionary<TKey, TValue>> asDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDictionary<TKey, TValue>> asWriteCachedDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDisposableDictionary<TKey, TValue>> asWriteCachedDisposableDictionary, Action dispose, Action flushCache) {
