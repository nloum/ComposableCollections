...
public class AnonymousReadCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> : IReadCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> {
...
public AnonymousReadCachedDisposableDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IDisposableDictionary<TKey, TValue>> asDisposableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IDisposableReadOnlyDictionary<TKey, TValue>> asDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableReadOnlyDictionary<TKey, TValue>> asReadCachedDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedReadOnlyDictionary<TKey, TValue>> asReadCachedReadOnlyDictionary, Action dispose, Action reloadCache) {
