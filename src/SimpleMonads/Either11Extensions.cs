...
public static SubTypesOf<TBase>.IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> Safely<TBase, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(this Cast<TBase>.IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> either) where T1 : TBase where T2 : TBase where T3 : TBase where T4 : TBase where T5 : TBase where T6 : TBase where T7 : TBase where T8 : TBase where T9 : TBase where T10 : TBase where T11 : TBase {
if (either.Item1.HasValue) {
