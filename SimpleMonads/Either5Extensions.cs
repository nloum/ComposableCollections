...
if (either.Item1 != null) {
return new SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5>(either.Item1);
}
if (either.Item2 != null) {
return new SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5>(either.Item2);
}
if (either.Item3 != null) {
return new SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5>(either.Item3);
}
if (either.Item4 != null) {
return new SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5>(either.Item4);
}
if (either.Item5 != null) {
return new SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5>(either.Item5);
}
