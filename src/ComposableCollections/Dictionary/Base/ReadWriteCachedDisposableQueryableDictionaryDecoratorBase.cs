...
public class ReadWriteCachedDisposableQueryableDictionaryDecoratorBase<TKey, TValue> : IReadWriteCachedDisposableQueryableDictionary<TKey, TValue> {
private readonly IReadWriteCachedDisposableQueryableDictionary<TKey, TValue> _decoratedObject;
public ReadWriteCachedDisposableQueryableDictionaryDecoratorBase(IReadWriteCachedDisposableQueryableDictionary<TKey, TValue> decoratedObject) {
