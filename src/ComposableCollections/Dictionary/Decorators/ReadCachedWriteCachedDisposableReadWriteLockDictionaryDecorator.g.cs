...
public class ReadCachedWriteCachedDisposableReadWriteLockDictionaryDecorator<TKey, TValue> : ReadWriteLockDictionaryDecorator<TKey, TValue>, IReadCachedWriteCachedDisposableDictionary<TKey, TValue> {
private readonly IReadCachedWriteCachedDisposableDictionary<TKey, TValue> _adapted;
public ReadCachedWriteCachedDisposableReadWriteLockDictionaryDecorator(IReadCachedWriteCachedDisposableDictionary<TKey, TValue> adapted) : base(adapted) {
_adapted = adapted;}
