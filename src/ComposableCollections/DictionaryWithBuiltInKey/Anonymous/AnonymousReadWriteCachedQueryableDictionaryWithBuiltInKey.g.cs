...
public class AnonymousReadWriteCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> : IReadWriteCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> {
...
private readonly Func<ComposableCollections.Dictionary.Interfaces.IReadWriteCachedQueryableDictionary<TKey, TValue>> _asReadWriteCachedQueryableDictionary;
...
public AnonymousReadWriteCachedQueryableDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IQueryableDictionary<TKey, TValue>> asQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IQueryableReadOnlyDictionary<TKey, TValue>> asQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedQueryableDictionary<TKey, TValue>> asReadCachedQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedQueryableReadOnlyDictionary<TKey, TValue>> asReadCachedQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedReadOnlyDictionary<TKey, TValue>> asReadCachedReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadWriteCachedQueryableDictionary<TKey, TValue>> asReadWriteCachedQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDictionary<TKey, TValue>> asWriteCachedDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedQueryableDictionary<TKey, TValue>> asWriteCachedQueryableDictionary, Action flushCache, Func<IQueryable<TValue>> getValues, Action reloadCache) {
_asReadWriteCachedQueryableDictionary = asReadWriteCachedQueryableDictionary;
...
public virtual ComposableCollections.Dictionary.Interfaces.IReadWriteCachedQueryableDictionary<TKey, TValue> AsReadWriteCachedQueryableDictionary() {
return _asReadWriteCachedQueryableDictionary();
}
