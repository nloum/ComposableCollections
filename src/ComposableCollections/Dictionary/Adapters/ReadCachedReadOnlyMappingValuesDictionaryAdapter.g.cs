...
public ReadCachedReadOnlyMappingValuesDictionaryAdapter(IReadCachedReadOnlyDictionary<TKey, TSourceValue> adapted, Func<TSourceValue, TValue> convertTo2) : base(adapted, convertTo2) {
_adapted = adapted;}
