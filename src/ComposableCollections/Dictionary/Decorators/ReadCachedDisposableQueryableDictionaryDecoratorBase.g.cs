...
public class ReadCachedDisposableQueryableDictionaryDecoratorBase<TKey, TValue> : IReadCachedDisposableQueryableDictionary<TKey, TValue> {
private readonly IReadCachedDisposableQueryableDictionary<TKey, TValue> _decoratedObject;
public ReadCachedDisposableQueryableDictionaryDecoratorBase(IReadCachedDisposableQueryableDictionary<TKey, TValue> decoratedObject) {
