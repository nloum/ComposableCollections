...
public class AnonymousReadCachedDictionaryWithBuiltInKey<TKey, TValue> : IReadCachedDictionaryWithBuiltInKey<TKey, TValue> {
...
public AnonymousReadCachedDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedReadOnlyDictionary<TKey, TValue>> asReadCachedReadOnlyDictionary, Action reloadCache) {
