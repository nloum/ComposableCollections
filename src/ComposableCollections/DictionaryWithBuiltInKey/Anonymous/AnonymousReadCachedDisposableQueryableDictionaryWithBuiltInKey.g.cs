...
public class AnonymousReadCachedDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> : IReadCachedDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> {
...
public AnonymousReadCachedDisposableQueryableDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IDisposableDictionary<TKey, TValue>> asDisposableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IDisposableReadOnlyDictionary<TKey, TValue>> asDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IQueryableDictionary<TKey, TValue>> asQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IQueryableReadOnlyDictionary<TKey, TValue>> asQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableQueryableDictionary<TKey, TValue>> asReadCachedDisposableQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableQueryableReadOnlyDictionary<TKey, TValue>> asReadCachedDisposableQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableReadOnlyDictionary<TKey, TValue>> asReadCachedDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedQueryableDictionary<TKey, TValue>> asReadCachedQueryableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedQueryableReadOnlyDictionary<TKey, TValue>> asReadCachedQueryableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedReadOnlyDictionary<TKey, TValue>> asReadCachedReadOnlyDictionary, Action dispose, Func<IQueryable<TValue>> getValues, Action reloadCache) {
