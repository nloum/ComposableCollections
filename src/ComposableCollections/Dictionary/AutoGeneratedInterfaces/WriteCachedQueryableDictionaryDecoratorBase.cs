...
public class WriteCachedQueryableDictionaryDecoratorBase<TKey, TValue> : IWriteCachedQueryableDictionary<TKey, TValue> {
private readonly IWriteCachedQueryableDictionary<TKey, TValue> _decoratedObject;
public WriteCachedQueryableDictionaryDecoratorBase(IWriteCachedQueryableDictionary<TKey, TValue> decoratedObject) {
