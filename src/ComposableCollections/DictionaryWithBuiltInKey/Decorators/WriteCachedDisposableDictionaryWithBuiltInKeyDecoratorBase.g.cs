...
public class WriteCachedDisposableDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IWriteCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IWriteCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public WriteCachedDisposableDictionaryWithBuiltInKeyDecoratorBase(IWriteCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
