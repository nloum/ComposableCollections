...
return new(t4);
        ...
        public static implicit operator Either<T1, T3, T2, T4>(EitherBase<T1, T2, T3, T4> either) {
            ...
            if (item1 != null) {
                return new Either<T1, T3, T2, T4>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T1, T3, T2, T4>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T1, T3, T2, T4>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T1, T3, T2, T4>(item4);
            }
        ...
        public static implicit operator Either<T1, T3, T4, T2>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T1, T3, T4, T2>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T1, T3, T4, T2>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T1, T3, T4, T2>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T1, T3, T4, T2>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T1, T4, T2, T3>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T1, T4, T2, T3>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T1, T4, T2, T3>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T1, T4, T2, T3>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T1, T4, T2, T3>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T1, T4, T3, T2>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T1, T4, T3, T2>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T1, T4, T3, T2>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T1, T4, T3, T2>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T1, T4, T3, T2>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T2, T1, T3, T4>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T2, T1, T3, T4>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T2, T1, T3, T4>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T2, T1, T3, T4>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T2, T1, T3, T4>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T2, T1, T4, T3>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T2, T1, T4, T3>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T2, T1, T4, T3>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T2, T1, T4, T3>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T2, T1, T4, T3>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T2, T3, T1, T4>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T2, T3, T1, T4>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T2, T3, T1, T4>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T2, T3, T1, T4>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T2, T3, T1, T4>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T2, T3, T4, T1>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T2, T3, T4, T1>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T2, T3, T4, T1>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T2, T3, T4, T1>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T2, T3, T4, T1>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T2, T4, T1, T3>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T2, T4, T1, T3>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T2, T4, T1, T3>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T2, T4, T1, T3>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T2, T4, T1, T3>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T2, T4, T3, T1>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T2, T4, T3, T1>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T2, T4, T3, T1>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T2, T4, T3, T1>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T2, T4, T3, T1>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T3, T1, T2, T4>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T3, T1, T2, T4>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T3, T1, T2, T4>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T3, T1, T2, T4>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T3, T1, T2, T4>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T3, T1, T4, T2>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T3, T1, T4, T2>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T3, T1, T4, T2>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T3, T1, T4, T2>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T3, T1, T4, T2>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T3, T2, T1, T4>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T3, T2, T1, T4>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T3, T2, T1, T4>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T3, T2, T1, T4>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T3, T2, T1, T4>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T3, T2, T4, T1>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T3, T2, T4, T1>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T3, T2, T4, T1>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T3, T2, T4, T1>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T3, T2, T4, T1>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T3, T4, T1, T2>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T3, T4, T1, T2>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T3, T4, T1, T2>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T3, T4, T1, T2>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T3, T4, T1, T2>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T3, T4, T2, T1>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T3, T4, T2, T1>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T3, T4, T2, T1>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T3, T4, T2, T1>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T3, T4, T2, T1>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T4, T1, T2, T3>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T4, T1, T2, T3>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T4, T1, T2, T3>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T4, T1, T2, T3>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T4, T1, T2, T3>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T4, T1, T3, T2>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T4, T1, T3, T2>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T4, T1, T3, T2>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T4, T1, T3, T2>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T4, T1, T3, T2>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T4, T2, T1, T3>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T4, T2, T1, T3>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T4, T2, T1, T3>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T4, T2, T1, T3>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T4, T2, T1, T3>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T4, T2, T3, T1>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T4, T2, T3, T1>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T4, T2, T3, T1>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T4, T2, T3, T1>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T4, T2, T3, T1>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T4, T3, T1, T2>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T4, T3, T1, T2>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T4, T3, T1, T2>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T4, T3, T1, T2>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T4, T3, T1, T2>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
        public static implicit operator Either<T4, T3, T2, T1>(EitherBase<T1, T2, T3, T4> either) {
            var item1 = either.Item1;
            if (item1 != null) {
                return new Either<T4, T3, T2, T1>(item1);
            }
            var item2 = either.Item2;
            if (item2 != null) {
                return new Either<T4, T3, T2, T1>(item2);
            }
            var item3 = either.Item3;
            if (item3 != null) {
                return new Either<T4, T3, T2, T1>(item3);
            }
            var item4 = either.Item4;
            if (item4 != null) {
                return new Either<T4, T3, T2, T1>(item4);
            }
            throw new InvalidOperationException("The Either has no values");
        }
