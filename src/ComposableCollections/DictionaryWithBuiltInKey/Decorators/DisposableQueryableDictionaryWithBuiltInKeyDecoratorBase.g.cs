...
public class DisposableQueryableDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public DisposableQueryableDictionaryWithBuiltInKeyDecoratorBase(IDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
