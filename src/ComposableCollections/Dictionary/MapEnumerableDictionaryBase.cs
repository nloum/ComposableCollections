...
namespace ComposableCollections.Dictionary
{
    ...
    public abstract class MapEnumerableDictionaryBase<TKey, TValue, TInnerValue> : DictionaryBaseEx<TKey, TValue> where TValue : class
    {
        ...
        private class InternalEnumerable<TKey, TValue> : IEnumerable<IKeyValuePair<TKey, TValue>>
        {
        ...
        private class InternalEnumerator<TKey, TValue> : IEnumerator<IKeyValuePair<TKey, TValue>> {
            public IKeyValuePair<TKey, TValue> Next { get; set; }
            ...
            public IKeyValuePair<TKey, TValue> Current { get; private set; }
        }
        ...
        public override void Mutate(IEnumerable<DictionaryMutation<TKey, TValue>> mutations, out IReadOnlyList<DictionaryMutationResult<TKey, TValue>> results)
        {
            ...
            using (var convertedObjectsEnumerator = Convert(objectsToBeConverted).GetEnumerator())
            {
                ...
                {
                    objectsToBeConverted.Enumerator.Next = Utility.KeyValuePair(key, value);
                ...
                {
                    objectsToBeConvertedBack.Enumerator.Next = Utility.KeyValuePair(key, value);
