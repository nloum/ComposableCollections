...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8> ForEach<T1, T2, T3, T4, T5, T6, T7, T8>(this IEither<T1, T2, T3, T4, T5, T6, T7, T8> input, Action<T1> action1, Action<T2> action2, Action<T3> action3, Action<T4> action4, Action<T5> action5, Action<T6> action6, Action<T7> action7, Action<T8> action8) {
if (input.Item1.HasValue) {
