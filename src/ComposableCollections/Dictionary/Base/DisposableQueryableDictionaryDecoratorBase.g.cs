...
public class DisposableQueryableDictionaryDecoratorBase<TKey, TValue> : IDisposableQueryableDictionary<TKey, TValue> {
private readonly IDisposableQueryableDictionary<TKey, TValue> _decoratedObject;
