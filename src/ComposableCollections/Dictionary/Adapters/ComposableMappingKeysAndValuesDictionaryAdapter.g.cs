...
using ComposableCollections.Dictionary.Interfaces;using System.Collections.Generic;using ComposableCollections.Dictionary.Write;using System;using ComposableCollections.Dictionary;
namespace ComposableCollections.Dictionary.Adapters {
public class ComposableMappingKeysAndValuesDictionaryAdapter<TSourceKey, TSourceValue, TKey, TValue> : MappingKeysAndValuesReadOnlyDictionaryAdapter<TSourceKey, TSourceValue, TKey, TValue>, IComposableDictionary<TKey, TValue> {
private readonly IComposableDictionary<TSourceKey, TSourceValue> _adapted;
public ComposableMappingKeysAndValuesDictionaryAdapter(IComposableDictionary<TSourceKey, TSourceValue> adapted) : base(adapted) {
_adapted = adapted;}
public ComposableMappingKeysAndValuesDictionaryAdapter(IComposableDictionary<TSourceKey, TSourceValue> adapted, Func<TSourceKey, TSourceValue, IKeyValue<TKey, TValue>> convertTo2, Func<TSourceKey, TKey> convertToKey2, Func<TKey, TSourceKey> convertToKey1) : base(adapted, convertTo2, convertToKey2, convertToKey1) {
_adapted = adapted;}
