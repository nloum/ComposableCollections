...
{
    public class MappingReadOnlyDictionaryAdapter<TKey, TValue1, TValue2> : MappingReadOnlyDictionaryAdapter<TKey, TValue1, TKey, TValue2>
    {
        protected MappingReadOnlyDictionaryAdapter(IComposableReadOnlyDictionary<TKey, TValue1> innerValues) : base(innerValues)
        {
        }

        public MappingReadOnlyDictionaryAdapter(IComposableReadOnlyDictionary<TKey, TValue1> innerValues, Func<TKey, TValue1, IKeyValue<TKey, TValue2>> convertTo2) : base(innerValues, convertTo2, x => x, x => x)
        {
        }
    }
    
    public class MappingReadOnlyDictionaryAdapter<TKey1, TValue1, TKey2, TValue2> : ReadOnlyDictionaryBase<TKey2, TValue2>
    {
        ...
        protected MappingReadOnlyDictionaryAdapter(IComposableReadOnlyDictionary<TKey1, TValue1> innerValues)
        {
            _innerValues = innerValues;
        }

        public MappingReadOnlyDictionaryAdapter(IComposableReadOnlyDictionary<TKey1, TValue1> innerValues, Func<TKey1, TValue1, IKeyValue<TKey2, TValue2>> convertTo2, Func<TKey1, TKey2> convertToKey2, Func<TKey2, TKey1> convertToKey1)
        {
            _innerValues = innerValues;
