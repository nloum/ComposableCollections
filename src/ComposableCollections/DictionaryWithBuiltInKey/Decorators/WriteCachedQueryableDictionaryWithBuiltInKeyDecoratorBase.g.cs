...
public class WriteCachedQueryableDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IWriteCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IWriteCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public WriteCachedQueryableDictionaryWithBuiltInKeyDecoratorBase(IWriteCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
