...
public class AnonymousReadWriteCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> : IReadWriteCachedDisposableDictionaryWithBuiltInKey<TKey, TValue> {
...
private readonly Func<ComposableCollections.Dictionary.Interfaces.IReadWriteCachedDisposableDictionary<TKey, TValue>> _asReadWriteCachedDisposableDictionary;
...
public AnonymousReadWriteCachedDisposableDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IDisposableDictionary<TKey, TValue>> asDisposableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IDisposableReadOnlyDictionary<TKey, TValue>> asDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedDisposableReadOnlyDictionary<TKey, TValue>> asReadCachedDisposableReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadCachedReadOnlyDictionary<TKey, TValue>> asReadCachedReadOnlyDictionary, Func<ComposableCollections.Dictionary.Interfaces.IReadWriteCachedDisposableDictionary<TKey, TValue>> asReadWriteCachedDisposableDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDictionary<TKey, TValue>> asWriteCachedDictionary, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDisposableDictionary<TKey, TValue>> asWriteCachedDisposableDictionary, Action dispose, Action flushCache, Action reloadCache) {
_asReadWriteCachedDisposableDictionary = asReadWriteCachedDisposableDictionary;
...
public virtual ComposableCollections.Dictionary.Interfaces.IReadWriteCachedDisposableDictionary<TKey, TValue> AsReadWriteCachedDisposableDictionary() {
return _asReadWriteCachedDisposableDictionary();
}
