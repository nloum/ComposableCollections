...
public class QueryableReadOnlyDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IQueryableReadOnlyDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IQueryableReadOnlyDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
