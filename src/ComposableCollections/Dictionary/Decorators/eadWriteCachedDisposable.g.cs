...
public class eadWriteCachedDisposable<TKey, TValue> : ReadWriteLockDictionaryDecorator<TKey, TValue>, ReadWriteCachedDisposable<TKey, TValue> {
private readonly ReadWriteCachedDisposable<TKey, TValue> _adapted;
public eadWriteCachedDisposable(ReadWriteCachedDisposable<TKey, TValue> adapted) : base(adapted) {
_adapted = adapted;}
