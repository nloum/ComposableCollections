...
public class ReadCachedReadOnlyDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IReadCachedReadOnlyDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IReadCachedReadOnlyDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
