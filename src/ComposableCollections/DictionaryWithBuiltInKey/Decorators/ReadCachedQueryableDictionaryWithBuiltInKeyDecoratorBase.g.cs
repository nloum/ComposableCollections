...
public class ReadCachedQueryableDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IReadCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IReadCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public ReadCachedQueryableDictionaryWithBuiltInKeyDecoratorBase(IReadCachedQueryableDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
