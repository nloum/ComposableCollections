...
namespace ComposableCollections.Dictionary
{
    ...
    /// </summary>
    public class MapDictionary<TKey, TValue1, TValue2> : MapDictionary<TKey, TValue1, TKey, TValue2>
    {
        public MapDictionary(IComposableDictionary<TKey, TValue1> innerValues) : base(innerValues)
        {
        }

        public MapDictionary(IComposableDictionary<TKey, TValue1> innerValues, Func<TKey, TValue1, IKeyValue<TKey, TValue2>> convertTo2, Func<TKey, TValue2, IKeyValue<TKey, TValue1>> convertTo1) : base(innerValues, convertTo2, convertTo1, null, null)
        {
        }
    ...
    /// This class works whether innerValues changes underneath it or not.
    /// </summary>
    public class MapDictionary<TKey1, TValue1, TKey2, TValue2> : DictionaryBase<TKey2, TValue2>
    {
        ...
        protected MapDictionary(IComposableDictionary<TKey1, TValue1> innerValues)
        {
            _innerValues = innerValues;
        }

        public MapDictionary(IComposableDictionary<TKey1, TValue1> innerValues, Func<TKey1, TValue1, IKeyValue<TKey2, TValue2>> convertTo2, Func<TKey2, TValue2, IKeyValue<TKey1, TValue1>> convertTo1, Func<TKey2, TKey1> convertToKey1, Func<TKey1, TKey2> convertToKey2)
        {
            _innerValues = innerValues;
