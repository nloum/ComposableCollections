...
public static implicit operator T1(EitherBase<T1, T2, T3, T4, T5> either) {
return either.Item1.Value;
}
public static implicit operator T2(EitherBase<T1, T2, T3, T4, T5> either) {
return either.Item2.Value;
}
public static implicit operator T3(EitherBase<T1, T2, T3, T4, T5> either) {
return either.Item3.Value;
}
public static implicit operator T4(EitherBase<T1, T2, T3, T4, T5> either) {
return either.Item4.Value;
}
public static implicit operator T5(EitherBase<T1, T2, T3, T4, T5> either) {
return either.Item5.Value;
}
public static implicit operator Maybe<T1>(EitherBase<T1, T2, T3, T4, T5> either) {
return (Maybe<T1>)either.Item1;
}
public static implicit operator Maybe<T2>(EitherBase<T1, T2, T3, T4, T5> either) {
return (Maybe<T2>)either.Item2;
}
public static implicit operator Maybe<T3>(EitherBase<T1, T2, T3, T4, T5> either) {
return (Maybe<T3>)either.Item3;
}
public static implicit operator Maybe<T4>(EitherBase<T1, T2, T3, T4, T5> either) {
return (Maybe<T4>)either.Item4;
}
public static implicit operator Maybe<T5>(EitherBase<T1, T2, T3, T4, T5> either) {
return (Maybe<T5>)either.Item5;
}
public Cast<TBase>.IEither<T1, T2, T3, T4, T5> Cast<TBase>() {
if (Item1.HasValue) {
return new Cast<TBase>.Either<T1, T2, T3, T4, T5>(Item1.Value);
}
if (Item2.HasValue) {
return new Cast<TBase>.Either<T1, T2, T3, T4, T5>(Item2.Value);
}
if (Item3.HasValue) {
return new Cast<TBase>.Either<T1, T2, T3, T4, T5>(Item3.Value);
}
if (Item4.HasValue) {
return new Cast<TBase>.Either<T1, T2, T3, T4, T5>(Item4.Value);
}
if (Item5.HasValue) {
return new Cast<TBase>.Either<T1, T2, T3, T4, T5>(Item5.Value);
}
throw new InvalidOperationException("None of the Either items has a value, which violates a core assumption of this class. Did you override the Either class and break this assumption?");
}
}
...
public class Either<T1, T2, T3, T4, T5> : Cast<TBase>.Either<T1, T2, T3, T4, T5>, IEither<T1, T2, T3, T4, T5> where T1 : TBase where T2 : TBase where T3 : TBase where T4 : TBase where T5 : TBase
{
protected Either() { }
public Either(T1 item1) : base(item1) { }
