...
namespace ComposableCollections.Dictionary
{
    public class AnonymousCachedMapDictionary<TKey, TValue, TInnerValue> : CacheMapDictionaryBase<TKey, TValue, TInnerValue> where TValue : class
    {
        ...
        public AnonymousCachedMapDictionary(IComposableDictionary<TKey, TInnerValue> innerValues, Func<TKey, TValue, TInnerValue> convert, Func<TKey, TInnerValue, TValue> convertBack, IComposableDictionary<TKey, TValue> cache, bool proactivelyConvertAllValues = false) : base(innerValues, cache, proactivelyConvertAllValues)
        {
            _convert = convert;
