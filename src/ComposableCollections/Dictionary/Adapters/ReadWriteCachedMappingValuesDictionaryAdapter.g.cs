...
public ReadWriteCachedMappingValuesDictionaryAdapter(IReadWriteCachedDictionary<TKey, TSourceValue> adapted) : base(adapted) {
_adapted = adapted;}
public ReadWriteCachedMappingValuesDictionaryAdapter(IReadWriteCachedDictionary<TKey, TSourceValue> adapted, Func<TKey, TSourceValue, TValue> convertTo2, Func<TKey, TValue, TSourceValue> convertTo1) : base(adapted, convertTo2, convertTo1) {
_adapted = adapted;}
