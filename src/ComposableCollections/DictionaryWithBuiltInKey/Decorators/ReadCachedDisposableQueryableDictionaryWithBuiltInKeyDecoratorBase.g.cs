...
public class ReadCachedDisposableQueryableDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IReadCachedDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IReadCachedDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public ReadCachedDisposableQueryableDictionaryWithBuiltInKeyDecoratorBase(IReadCachedDisposableQueryableDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
