...
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T1 t1) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t1);
}
public static implicit operator T1(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item1.Value;
}
public static implicit operator Maybe<T1>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T1>)either.Item1;
}
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T2 t2) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t2);
}
public static implicit operator T2(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item2.Value;
}
public static implicit operator Maybe<T2>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T2>)either.Item2;
}
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T3 t3) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t3);
}
public static implicit operator T3(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item3.Value;
}
public static implicit operator Maybe<T3>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T3>)either.Item3;
}
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T4 t4) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t4);
}
public static implicit operator T4(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item4.Value;
}
public static implicit operator Maybe<T4>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T4>)either.Item4;
}
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T5 t5) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t5);
}
public static implicit operator T5(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item5.Value;
}
public static implicit operator Maybe<T5>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T5>)either.Item5;
}
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T6 t6) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t6);
}
public static implicit operator T6(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item6.Value;
}
public static implicit operator Maybe<T6>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T6>)either.Item6;
}
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T7 t7) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t7);
}
public static implicit operator T7(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item7.Value;
}
public static implicit operator Maybe<T7>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T7>)either.Item7;
}
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T8 t8) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t8);
}
public static implicit operator T8(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item8.Value;
}
public static implicit operator Maybe<T8>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return (Maybe<T8>)either.Item8;
}
public static implicit operator SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(T9 t9) {
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9>(t9);
}
public static implicit operator T9(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
return either.Item9.Value;
}
public static implicit operator Maybe<T9>(SubTypesOf<TBase>.Either<T1, T2, T3, T4, T5, T6, T7, T8, T9> either) {
