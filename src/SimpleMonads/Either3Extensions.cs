...
{
public static IEither<T1B, T2, T3> Select1<T1A, T1B, T2, T3>(IEither<T1A, T2, T3> either, Func<T1A, T1B> selector)
{
...
public static IEither<T1, T2B, T3> Select2<T1, T2A, T2B, T3>(IEither<T1, T2A, T3> either, Func<T2A, T2B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3B> Select3<T1, T2, T3A, T3B>(IEither<T1, T2, T3A> either, Func<T3A, T3B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1B, T2B, T3B> Select<T1A, T2A, T3A, T1B, T2B, T3B>(this IEither<T1A, T2A, T3A> input, Func<T1A, T1B> selector1, Func<T2A, T2B> selector2, Func<T3A, T3B> selector3) {
