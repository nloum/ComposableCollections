...
public class AnonymousWriteCachedDictionaryWithBuiltInKey<TKey, TValue> : IWriteCachedDictionaryWithBuiltInKey<TKey, TValue> {
...
public AnonymousWriteCachedDictionaryWithBuiltInKey(IDictionaryWithBuiltInKey<TKey, TValue> dictionaryWithBuiltInKey, Func<ComposableCollections.Dictionary.Interfaces.IWriteCachedDictionary<TKey, TValue>> asWriteCachedDictionary, Action flushCache) {
