...
if (Item1.HasValue) {
return new ConvertibleTo<TBase>.Either<T1, T2, T3, T4, T5, T6, T7>(Item1.Value);
}
if (Item2.HasValue) {
return new ConvertibleTo<TBase>.Either<T1, T2, T3, T4, T5, T6, T7>(Item2.Value);
}
if (Item3.HasValue) {
return new ConvertibleTo<TBase>.Either<T1, T2, T3, T4, T5, T6, T7>(Item3.Value);
}
if (Item4.HasValue) {
return new ConvertibleTo<TBase>.Either<T1, T2, T3, T4, T5, T6, T7>(Item4.Value);
}
if (Item5.HasValue) {
return new ConvertibleTo<TBase>.Either<T1, T2, T3, T4, T5, T6, T7>(Item5.Value);
}
if (Item6.HasValue) {
return new ConvertibleTo<TBase>.Either<T1, T2, T3, T4, T5, T6, T7>(Item6.Value);
}
if (Item7.HasValue) {
return new ConvertibleTo<TBase>.Either<T1, T2, T3, T4, T5, T6, T7>(Item7.Value);
}
throw new InvalidOperationException("None of the Either items has a value, which violates a core assumption of this class. Did you override the Either class and break this assumption?");
}
}
