...
public class WriteCachedDisposableDictionaryDecoratorBase<TKey, TValue> : IWriteCachedDisposableDictionary<TKey, TValue> {
private readonly IWriteCachedDisposableDictionary<TKey, TValue> _decoratedObject;
