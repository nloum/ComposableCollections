...
{
    public class ConcurrentWriteCachedDictionary<TKey, TValue> : DictionaryBase<TKey, TValue>, IWriteCachedDictionary<TKey, TValue>
    {
        ...
        public ConcurrentWriteCachedDictionary(IComposableDictionary<TKey, TValue> flushCacheTo, IComposableDictionary<TKey, TValue> cache)
        {
            _cache = cache;
