...
{
public static IEither<T1B, T2, T3, T4, T5, T6, T7, T8, T9> Select1<T1A, T1B, T2, T3, T4, T5, T6, T7, T8, T9>(IEither<T1A, T2, T3, T4, T5, T6, T7, T8, T9> either, Func<T1A, T1B> selector)
{
...
public static IEither<T1, T2B, T3, T4, T5, T6, T7, T8, T9> Select2<T1, T2A, T2B, T3, T4, T5, T6, T7, T8, T9>(IEither<T1, T2A, T3, T4, T5, T6, T7, T8, T9> either, Func<T2A, T2B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3B, T4, T5, T6, T7, T8, T9> Select3<T1, T2, T3A, T3B, T4, T5, T6, T7, T8, T9>(IEither<T1, T2, T3A, T4, T5, T6, T7, T8, T9> either, Func<T3A, T3B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3, T4B, T5, T6, T7, T8, T9> Select4<T1, T2, T3, T4A, T4B, T5, T6, T7, T8, T9>(IEither<T1, T2, T3, T4A, T5, T6, T7, T8, T9> either, Func<T4A, T4B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5B, T6, T7, T8, T9> Select5<T1, T2, T3, T4, T5A, T5B, T6, T7, T8, T9>(IEither<T1, T2, T3, T4, T5A, T6, T7, T8, T9> either, Func<T5A, T5B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6B, T7, T8, T9> Select6<T1, T2, T3, T4, T5, T6A, T6B, T7, T8, T9>(IEither<T1, T2, T3, T4, T5, T6A, T7, T8, T9> either, Func<T6A, T6B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7B, T8, T9> Select7<T1, T2, T3, T4, T5, T6, T7A, T7B, T8, T9>(IEither<T1, T2, T3, T4, T5, T6, T7A, T8, T9> either, Func<T7A, T7B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8B, T9> Select8<T1, T2, T3, T4, T5, T6, T7, T8A, T8B, T9>(IEither<T1, T2, T3, T4, T5, T6, T7, T8A, T9> either, Func<T8A, T8B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9B> Select9<T1, T2, T3, T4, T5, T6, T7, T8, T9A, T9B>(IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9A> either, Func<T9A, T9B> selector)
{
if (either.Item1.HasValue) {
...
public static IEither<T1B, T2B, T3B, T4B, T5B, T6B, T7B, T8B, T9B> Select<T1A, T2A, T3A, T4A, T5A, T6A, T7A, T8A, T9A, T1B, T2B, T3B, T4B, T5B, T6B, T7B, T8B, T9B>(this IEither<T1A, T2A, T3A, T4A, T5A, T6A, T7A, T8A, T9A> input, Func<T1A, T1B> selector1, Func<T2A, T2B> selector2, Func<T3A, T3B> selector3, Func<T4A, T4B> selector4, Func<T5A, T5B> selector5, Func<T6A, T6B> selector6, Func<T7A, T7B> selector7, Func<T8A, T8B> selector8, Func<T9A, T9B> selector9) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9> ForEach<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9> input, Action<T1> action1, Action<T2> action2, Action<T3> action3, Action<T4> action4, Action<T5> action5, Action<T6> action6, Action<T7> action7, Action<T8> action8, Action<T9> action9) {
if (input.Item1.HasValue) {
