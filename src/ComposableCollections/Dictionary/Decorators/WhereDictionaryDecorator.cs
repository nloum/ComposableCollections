...
{
    public class WhereDictionaryDecorator<TKey, TValue> : IComposableDictionary<TKey, TValue>
    {
        ...
        public WhereDictionaryDecorator(IComposableDictionary<TKey, TValue> source, Func<TKey, TValue, bool> predicate, bool autoRemove)
        {
            _source = source;
        ...
        public WhereDictionaryDecorator(IComposableDictionary<TKey, TValue> source, Func<TValue, bool> predicate, bool autoRemove) : this(source, (key, value) => predicate(value), autoRemove)
        {
        }
