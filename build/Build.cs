...
class Build : NukeBuild
{
 ...
 //    [GitVersion]
    ...
    Project PackageProject => Solution.GetProject("ComposableCollections");
    ...
    public GitVersion GitVersion
    {
	    get
	    {
		    ...
		    var settings = new GitVersionSettings().SetToolPath(package.Directory / "tools/net5.0/any/gitversion.dll");
