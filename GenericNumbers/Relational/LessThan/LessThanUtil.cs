            ...
            if (LessThan == null)
            {
                ...
                else
                {
                    LessThan = (arg1, input) =>
                    {
                        ...
                        throw new ArgumentException($"An attempt was made to determine whether a {nameof(T)} was less than a {nameof(TInput)} but {nameof(T)} is not an IComparable<{nameof(TInput)}> or an IComparable");
                    };
                }
