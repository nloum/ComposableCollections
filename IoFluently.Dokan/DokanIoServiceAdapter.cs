...
//
//         public Mirror(IIoService ioService)
//         {
//             _ioService = ioService;
//         }
//
//         protected IFileOrFolderOrMissingPath GetPath(string fileName)
//         {
//             return _ioService.ParseAbsolutePath(fileName, _ioService.DefaultRoot);
//         }
//
...
//                                 try
//                                 {
//                                     if (!filePath.Attributes.HasFlag(FileAttributes.Directory))
...
//                             try
//                             {
//                                 filePath.Attributes.HasFlag(FileAttributes.Directory);
//                                 return Trace(nameof(CreateFile), fileName, info, access, share, mode, options,
...
//                 try
//                 {
//                     pathExists = (filePath.IsDirectory || filePath.IsFile);
//                     pathIsDirectory = pathExists ? filePath.Attributes.HasFlag(FileAttributes.Directory) : false;
//                 }
//                 catch (IOException)
//                 {
//                 }
...
//             info.Context = null;
//
//             var exist = info.IsDirectory ? Directory.Exists(newpath) : newpath.IsFile;
//
//             try
//             {
//
...
//                     else
//                         oldpath.Translate(newpath).Move();
