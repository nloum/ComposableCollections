...
public AnonymousWriteCachedDisposableQueryableDictionary(IComposableDictionary<TKey, TValue> composableDictionary, Action dispose, Action flushCache, Func<IQueryable<TValue>> getValues) {
