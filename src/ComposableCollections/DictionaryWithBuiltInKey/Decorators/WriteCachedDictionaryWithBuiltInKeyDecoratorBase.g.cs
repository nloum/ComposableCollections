...
public class WriteCachedDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IWriteCachedDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IWriteCachedDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public WriteCachedDictionaryWithBuiltInKeyDecoratorBase(IWriteCachedDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
