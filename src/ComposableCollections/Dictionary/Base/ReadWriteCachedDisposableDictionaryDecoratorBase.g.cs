...
public class ReadWriteCachedDisposableDictionaryDecoratorBase<TKey, TValue> : IReadWriteCachedDisposableDictionary<TKey, TValue> {
private readonly IReadWriteCachedDisposableDictionary<TKey, TValue> _decoratedObject;
public ReadWriteCachedDisposableDictionaryDecoratorBase(IReadWriteCachedDisposableDictionary<TKey, TValue> decoratedObject) {
