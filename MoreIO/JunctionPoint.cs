...
namespace MoreIO
{
    ...
    public static class JunctionPoint
    {
        ...
        /// </remarks>
        /// <param name="junctionPoint">The junction point path</param>
        public static void DeleteJunctionPoint(this PathSpec junctionPoint)
        {
            if (junctionPoint.GetPathType() != PathType.Folder)
            {
                if (junctionPoint.GetPathType() == PathType.File)
        ...
        public static bool IsJunctionPoint(this PathSpec path)
        {
            if (path.GetPathType() != PathType.Folder)
                return false;

            using (SafeFileHandle handle = OpenReparsePoint(path.ToString(), EFileAccess.GenericRead))
            {
        ...
        public static IMaybe<PathSpec> GetJunctionPointTarget(this PathSpec junctionPoint)
        {
            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint.ToString(), EFileAccess.GenericRead))
            {
                string target = InternalGetTarget(handle);
