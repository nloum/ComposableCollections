...
{
    public class AnonymousCachedMapDictionary<TKey, TValue, TInnerValue> : CachedMapDictionaryBase<TKey, TValue, TInnerValue> where TValue : class
    {
        ...
        public AnonymousCachedMapDictionary(IDictionaryEx<TKey, TInnerValue> innerValues, Func<Func<TKey, TValue, TInnerValue>, TKey, TValue, TInnerValue> convert, Func<Func<TKey, TInnerValue, TValue>, TKey, TInnerValue, TValue> convertBack, bool proactivelyConvertAllValues) : base(innerValues, proactivelyConvertAllValues)
        {
            _convert = convert;
