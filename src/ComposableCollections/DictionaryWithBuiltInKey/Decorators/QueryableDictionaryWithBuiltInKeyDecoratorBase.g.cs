...
public class QueryableDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IQueryableDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IQueryableDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public QueryableDictionaryWithBuiltInKeyDecoratorBase(IQueryableDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
