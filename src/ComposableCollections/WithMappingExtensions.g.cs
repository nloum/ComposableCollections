...
return new ReadCachedWriteCachedMappingValuesDictionaryAdapter<TKey, TSourceValue, TValue>(adapted, convertTo2, convertTo1);}
public static ReadWriteCachedDisposableQueryable<TKey, TValue> WithMapping<TSourceKey, TSourceValue, TKey, TValue>(this ReadWriteCachedDisposableQueryable<TSourceKey, TSourceValue> adapted, Expression<Func<TSourceValue, TValue>> convertTo2, Func<TValue, TSourceValue> convertTo1, Func<TSourceKey, TKey> convertToKey2, Func<TKey, TSourceKey> convertToKey1) {
return new eadWriteCachedDisposableQueryable<TSourceKey, TSourceValue, TKey, TValue>(adapted, convertTo2, convertTo1, convertToKey2, convertToKey1);}
...
return new ReadCachedWriteCachedDisposableMappingValuesDictionaryAdapter<TKey, TSourceValue, TValue>(adapted, convertTo2, convertTo1);}
public static ReadWriteCachedDisposable<TKey, TValue> WithMapping<TSourceKey, TSourceValue, TKey, TValue>(this ReadWriteCachedDisposable<TSourceKey, TSourceValue> adapted, Func<TSourceKey, TSourceValue, IKeyValue<TKey, TValue>> convertTo2, Func<TKey, TValue, IKeyValue<TSourceKey, TSourceValue>> convertTo1, Func<TSourceKey, TKey> convertToKey2, Func<TKey, TSourceKey> convertToKey1) {
return new eadWriteCachedDisposable<TSourceKey, TSourceValue, TKey, TValue>(adapted, convertTo2, convertTo1, convertToKey2, convertToKey1);}
public static ReadWriteCachedDisposable<TKey, TValue> WithMapping<TSourceKey, TSourceValue, TKey, TValue>(this ReadWriteCachedDisposable<TSourceKey, TSourceValue> adapted, Func<TSourceValue, TValue> convertTo2, Func<TValue, TSourceValue> convertTo1, Func<TSourceKey, TKey> convertToKey2, Func<TKey, TSourceKey> convertToKey1) {
return new eadWriteCachedDisposable<TSourceKey, TSourceValue, TKey, TValue>(adapted, convertTo2, convertTo1, convertToKey2, convertToKey1);}
...
return new WriteCachedDisposableMappingKeysAndValuesDictionaryAdapter<TSourceKey, TSourceValue, TKey, TValue>(adapted, convertTo2, convertTo1, convertToKey2, convertToKey1);}
public static ReadWriteCachedQueryable<TKey, TValue> WithMapping<TSourceKey, TSourceValue, TKey, TValue>(this ReadWriteCachedQueryable<TSourceKey, TSourceValue> adapted, Expression<Func<TSourceValue, TValue>> convertTo2, Func<TValue, TSourceValue> convertTo1, Func<TSourceKey, TKey> convertToKey2, Func<TKey, TSourceKey> convertToKey1) {
return new eadWriteCachedQueryable<TSourceKey, TSourceValue, TKey, TValue>(adapted, convertTo2, convertTo1, convertToKey2, convertToKey1);}
...
public static ReadWriteCached<TKey, TValue> WithMapping<TSourceKey, TSourceValue, TKey, TValue>(this ReadWriteCached<TSourceKey, TSourceValue> adapted, Func<TSourceKey, TSourceValue, IKeyValue<TKey, TValue>> convertTo2, Func<TKey, TValue, IKeyValue<TSourceKey, TSourceValue>> convertTo1, Func<TSourceKey, TKey> convertToKey2, Func<TKey, TSourceKey> convertToKey1) {
return new eadWriteCached<TSourceKey, TSourceValue, TKey, TValue>(adapted, convertTo2, convertTo1, convertToKey2, convertToKey1);}
public static ReadWriteCached<TKey, TValue> WithMapping<TSourceKey, TSourceValue, TKey, TValue>(this ReadWriteCached<TSourceKey, TSourceValue> adapted, Func<TSourceValue, TValue> convertTo2, Func<TValue, TSourceValue> convertTo1, Func<TSourceKey, TKey> convertToKey2, Func<TKey, TSourceKey> convertToKey1) {
return new eadWriteCached<TSourceKey, TSourceValue, TKey, TValue>(adapted, convertTo2, convertTo1, convertToKey2, convertToKey1);}
