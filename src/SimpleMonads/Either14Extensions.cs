...
{
public static IEither<T1B, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> Select1<T1A, T1B, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(IEither<T1A, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> either, Func<T1A, T1B> selector)
{
if (either.Item1.HasValue) {
return new Either<T1B, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(selector(either.Item1.Value));
}
...
public static IEither<T1, T2B, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> Select2<T1, T2A, T2B, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(IEither<T1, T2A, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> either, Func<T2A, T2B> selector)
{
if (either.Item1.HasValue) {
return new Either<T1, T2B, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(either.Item1.Value);
}
else if (either.Item2.HasValue) {
return new Either<T1, T2B, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(selector(either.Item2.Value));
}
else if (either.Item3.HasValue) {
...
public static IEither<T1, T2, T3B, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> Select3<T1, T2, T3A, T3B, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(IEither<T1, T2, T3A, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> either, Func<T3A, T3B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3B, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(selector(either.Item3.Value));
}
else if (either.Item4.HasValue) {
...
public static IEither<T1, T2, T3, T4B, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> Select4<T1, T2, T3, T4A, T4B, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(IEither<T1, T2, T3, T4A, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> either, Func<T4A, T4B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4B, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(selector(either.Item4.Value));
}
else if (either.Item5.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5B, T6, T7, T8, T9, T10, T11, T12, T13, T14> Select5<T1, T2, T3, T4, T5A, T5B, T6, T7, T8, T9, T10, T11, T12, T13, T14>(IEither<T1, T2, T3, T4, T5A, T6, T7, T8, T9, T10, T11, T12, T13, T14> either, Func<T5A, T5B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5B, T6, T7, T8, T9, T10, T11, T12, T13, T14>(selector(either.Item5.Value));
}
else if (either.Item6.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6B, T7, T8, T9, T10, T11, T12, T13, T14> Select6<T1, T2, T3, T4, T5, T6A, T6B, T7, T8, T9, T10, T11, T12, T13, T14>(IEither<T1, T2, T3, T4, T5, T6A, T7, T8, T9, T10, T11, T12, T13, T14> either, Func<T6A, T6B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6B, T7, T8, T9, T10, T11, T12, T13, T14>(selector(either.Item6.Value));
}
else if (either.Item7.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7B, T8, T9, T10, T11, T12, T13, T14> Select7<T1, T2, T3, T4, T5, T6, T7A, T7B, T8, T9, T10, T11, T12, T13, T14>(IEither<T1, T2, T3, T4, T5, T6, T7A, T8, T9, T10, T11, T12, T13, T14> either, Func<T7A, T7B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6, T7B, T8, T9, T10, T11, T12, T13, T14>(selector(either.Item7.Value));
}
else if (either.Item8.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8B, T9, T10, T11, T12, T13, T14> Select8<T1, T2, T3, T4, T5, T6, T7, T8A, T8B, T9, T10, T11, T12, T13, T14>(IEither<T1, T2, T3, T4, T5, T6, T7, T8A, T9, T10, T11, T12, T13, T14> either, Func<T8A, T8B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6, T7, T8B, T9, T10, T11, T12, T13, T14>(selector(either.Item8.Value));
}
else if (either.Item9.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9B, T10, T11, T12, T13, T14> Select9<T1, T2, T3, T4, T5, T6, T7, T8, T9A, T9B, T10, T11, T12, T13, T14>(IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9A, T10, T11, T12, T13, T14> either, Func<T9A, T9B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9B, T10, T11, T12, T13, T14>(selector(either.Item9.Value));
}
else if (either.Item10.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10B, T11, T12, T13, T14> Select10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10A, T10B, T11, T12, T13, T14>(IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10A, T11, T12, T13, T14> either, Func<T10A, T10B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10B, T11, T12, T13, T14>(selector(either.Item10.Value));
}
else if (either.Item11.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11B, T12, T13, T14> Select11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11A, T11B, T12, T13, T14>(IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11A, T12, T13, T14> either, Func<T11A, T11B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11B, T12, T13, T14>(selector(either.Item11.Value));
}
else if (either.Item12.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12B, T13, T14> Select12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12A, T12B, T13, T14>(IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12A, T13, T14> either, Func<T12A, T12B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12B, T13, T14>(selector(either.Item12.Value));
}
else if (either.Item13.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13B, T14> Select13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13A, T13B, T14>(IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13A, T14> either, Func<T13A, T13B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13B, T14>(selector(either.Item13.Value));
}
else if (either.Item14.HasValue) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14B> Select14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14A, T14B>(IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14A> either, Func<T14A, T14B> selector)
{
if (either.Item1.HasValue) {
...
return new Either<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14B>(selector(either.Item14.Value));
}
else {
throw new InvalidOperationException();
}
}
public static IEither<T1B, T2B, T3B, T4B, T5B, T6B, T7B, T8B, T9B, T10B, T11B, T12B, T13B, T14B> Select<T1A, T2A, T3A, T4A, T5A, T6A, T7A, T8A, T9A, T10A, T11A, T12A, T13A, T14A, T1B, T2B, T3B, T4B, T5B, T6B, T7B, T8B, T9B, T10B, T11B, T12B, T13B, T14B>(this IEither<T1A, T2A, T3A, T4A, T5A, T6A, T7A, T8A, T9A, T10A, T11A, T12A, T13A, T14A> input, Func<T1A, T1B> selector1, Func<T2A, T2B> selector2, Func<T3A, T3B> selector3, Func<T4A, T4B> selector4, Func<T5A, T5B> selector5, Func<T6A, T6B> selector6, Func<T7A, T7B> selector7, Func<T8A, T8B> selector8, Func<T9A, T9B> selector9, Func<T10A, T10B> selector10, Func<T11A, T11B> selector11, Func<T12A, T12B> selector12, Func<T13A, T13B> selector13, Func<T14A, T14B> selector14) {
...
public static IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> ForEach<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(this IEither<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> input, Action<T1> action1, Action<T2> action2, Action<T3> action3, Action<T4> action4, Action<T5> action5, Action<T6> action6, Action<T7> action7, Action<T8> action8, Action<T9> action9, Action<T10> action10, Action<T11> action11, Action<T12> action12, Action<T13> action13, Action<T14> action14) {
if (input.Item1.HasValue) {
