...
public static IQueryableDictionary<TKey, TValue> WithReadWriteLock<TKey, TValue>(this IQueryableDictionary<TKey, TValue> adapted) {
return new Queryable<TKey, TValue>(adapted);}
...
return new WriteCached<TKey, TValue>(adapted);}
