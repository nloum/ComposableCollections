...
public class eadConcurrentWriteCachedDisposableQueryable<TKey, TValue> : ConcurrentWriteCachedDictionaryAdapter<TKey, TValue>, ReadWriteCachedDisposableQueryable<TKey, TValue> {
private readonly ReadWriteCachedDisposableQueryable<TKey, TValue> _adapted;
public eadConcurrentWriteCachedDisposableQueryable(ReadWriteCachedDisposableQueryable<TKey, TValue> adapted, IComposableDictionary<TKey, TValue> addedOrUpdated, IComposableDictionary<TKey, TValue> removed) : base(adapted, addedOrUpdated, removed) {
_adapted = adapted;}
