...
public AnonymousWriteCachedQueryableDictionary(IComposableDictionary<TKey, TValue> composableDictionary, Action flushCache, Func<IQueryable<TValue>> getValues) {
