...
{
    public class DictionaryGetOrRefreshDecorator<TKey, TValue> : IDictionaryEx<TKey, TValue>
    {
        private IDictionaryEx<TKey, TValue> _wrapped;
        private RefreshValue<TKey, TValue> _refreshValue;

        public DictionaryGetOrRefreshDecorator(IDictionaryEx<TKey, TValue> wrapped, RefreshValue<TKey, TValue> refreshValue)
        {
            _wrapped = wrapped;
        ...
        protected void Initialize(IDictionaryEx<TKey, TValue> wrapped, RefreshValue<TKey, TValue> getDefaultValue)
        {
            _wrapped = wrapped;
