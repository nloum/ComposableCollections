...
public class ReadCachedWriteCachedReadWriteLockDictionaryDecorator<TKey, TValue> : ReadWriteLockDictionaryDecorator<TKey, TValue>, IReadCachedWriteCachedDictionary<TKey, TValue> {
private readonly IReadCachedWriteCachedDictionary<TKey, TValue> _adapted;
public ReadCachedWriteCachedReadWriteLockDictionaryDecorator(IReadCachedWriteCachedDictionary<TKey, TValue> adapted) : base(adapted) {
_adapted = adapted;}
