...
public class ReadCachedDictionaryWithBuiltInKeyDecoratorBase<TKey, TValue> : IReadCachedDictionaryWithBuiltInKey<TKey, TValue> {
private readonly IReadCachedDictionaryWithBuiltInKey<TKey, TValue> _decoratedObject;
public ReadCachedDictionaryWithBuiltInKeyDecoratorBase(IReadCachedDictionaryWithBuiltInKey<TKey, TValue> decoratedObject) {
