...
namespace ComposableCollections.List
{
    public static class OrderedListExtensions
    {
        ...
        #region Binary search - read only lists
        ...
        /// <param name="max">Specifies the maximum index at which the element might be found. This can be used to ignore big portions of the list, reducing the number of iterations the search must perform. This can be a relative index.</param>
        /// <returns>The absolute index of the element if found; otherwise, returns -1</returns>
        public static INumberRange<int> RangeBinarySearch<T>(this IList<T> haystack, Func<T, int> needle, int min = 0, int max = -1)
        {
            var rangeMin = haystack.GetIndexOfSortedInsert(t =>
            {
                var result = needle(t);
        ...
        /// <param name="max">Specifies the maximum index at which the element might be found. This can be used to ignore big portions of the list, reducing the number of iterations the search must perform. This can be a relative index.</param>
        /// <returns>The absolute index of the element if found; otherwise, returns -1</returns>
        public static INumberRange<int> RangeBinarySearch<T>(this IList<T> haystack, T needle, Func<T, T, int> compare, int min = 0, int max = -1)
        {
            var rangeMin = haystack.GetIndexOfSortedInsert(t =>
            {
                var result = compare(t, needle);
        ...
        /// <param name="max">Specifies the maximum index at which the element might be found. This can be used to ignore big portions of the list, reducing the number of iterations the search must perform. This can be a relative index.</param>
        /// <returns>The absolute index of the element if found; otherwise, returns -1</returns>
        public static INumberRange<int> RangeBinarySearch<T>(this IList<T> haystack, T needle, int min = 0, int max = -1)
        {
            var rangeMin = haystack.GetIndexOfSortedInsert(t =>
            {
                var result = t.CompareTo(needle);
        ...
        /// <param name="max">Specifies the maximum index at which the element might be found. This can be used to ignore big portions of the list, reducing the number of iterations the search must perform. This can be a relative index.</param>
        /// <returns>The absolute index of the element if found; otherwise, returns -1</returns>
        public static INumberRange<int> RangeBinarySearch<T, TKey>(this IList<T> haystack, T needle, Func<T, TKey> keySelector, int min = 0, int max = -1)
        {
            var rangeMin = haystack.GetIndexOfSortedInsert(t =>
            {
                var result = keySelector(t).CompareTo(keySelector(needle));
        ...
        /// <param name="max">Specifies the maximum index at which the element might be found. This can be used to ignore big portions of the list, reducing the number of iterations the search must perform. This can be a relative index.</param>
        /// <returns>The absolute index of the element if found; otherwise, returns -1</returns>
        public static int BinarySearch<T>(this IList<T> haystack, T needle, int min = 0, int max = -1)
        {
            return haystack.BinarySearch(t => t.CompareTo(needle), min, max);
        }
        ...
        /// <param name="max">Specifies the maximum index at which the element might be found. This can be used to ignore big portions of the list, reducing the number of iterations the search must perform. This can be a relative index.</param>
        /// <returns>The absolute index of the element if found; otherwise, returns -1</returns>
        public static int BinarySearch<T, TKey>(this IList<T> haystack, T needle, Func<T, TKey> keySelector, int min = 0, int max = -1)
        {
            return haystack.BinarySearch(t => keySelector(t).CompareTo(keySelector(needle)), min, max);
        }
        ...
        /// <param name="max">Specifies the maximum index at which the element might be found. This can be used to ignore big portions of the list, reducing the number of iterations the search must perform. This can be a relative index.</param>
        /// <returns>The absolute index of the element if found; otherwise, returns -1</returns>
        public static int BinarySearch<T>(this IList<T> haystack, T needle, Func<T, T, int> comparer, int min = 0, int max = -1)
        {
            return haystack.BinarySearch(t => comparer(t, needle), min, max);
        }
        ...
        /// <param name="max">Specifies the maximum index at which the element might be found. This can be used to ignore big portions of the list, reducing the number of iterations the search must perform. This can be a relative index.</param>
        /// <returns>The absolute index of the element if found; otherwise, returns -1</returns>
        public static int BinarySearch<T>(this IList<T> haystack, Func<T, int> by, int min = 0, int max = -1)
        {
            if (haystack.Count == 0)
                return -1;
            min = haystack.GetAbsoluteIndex(min);
