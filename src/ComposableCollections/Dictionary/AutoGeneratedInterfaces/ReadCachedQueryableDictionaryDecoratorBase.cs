...
public class ReadCachedQueryableDictionaryDecoratorBase<TKey, TValue> : IReadCachedQueryableDictionary<TKey, TValue> {
private readonly IReadCachedQueryableDictionary<TKey, TValue> _decoratedObject;
public ReadCachedQueryableDictionaryDecoratorBase(IReadCachedQueryableDictionary<TKey, TValue> decoratedObject) {
