...
{
    public abstract class DelegateDictionaryBase<TKey, TValue> : IComposableDictionary<TKey, TValue>
    {
        private IComposableDictionary<TKey, TValue> _source;

        public DelegateDictionaryBase(IComposableDictionary<TKey, TValue> source)
        {
            _source = source;
        }

        protected DelegateDictionaryBase()
        {
            _source = null;
        }
